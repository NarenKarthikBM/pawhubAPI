...
VULTR_ACCESS_KEY_ID = env.str("VULTR_ACCESS_KEY_ID", default="")
VULTR_SECRET_ACCESS_KEY = env.str("VULTR_SECRET_ACCESS_KEY", default="")
VULTR_ENDPOINT_URL = env.str("VULTR_ENDPOINT_URL", default="")
VULTR_REGION = env.str("VULTR_REGION", default="")
VULTR_BUCKET_NAME = env.str("VULTR_BUCKET_NAME", default="")
